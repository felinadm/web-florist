...
export const Kasir: React.FC = () => {
  ...
  return (
    <div className="h-[calc(100vh-80px)] overflow-hidden bg-gray-100 -m-4 lg:-m-8">
      <div className="flex flex-col lg:flex-row h-full no-print">
        ...
        <div className="flex-1 lg:flex-[0.65] flex flex-col h-full min-h-0 bg-gray-100">
          {/* Sticky Search Bar */}
          <div className="p-4 lg:p-6 bg-gray-100 sticky top-0 z-10">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 outline-none transition-all shadow-sm font-medium"
              />
            </div>
          </div>
        ...
        <div className="hidden lg:flex lg:flex-[0.35] flex-col h-full bg-white border-l border-slate-200 shadow-xl">
          <CartContent 
            cart={cart} 
          ...
          {isMobileCartOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed bottom-0 left-0 right-0 bg-white rounded-t-[40px] z-[60] h-[85vh] flex flex-col lg:hidden shadow-2xl"
              >
                <div className="w-12 h-1.5 bg-slate-200 rounded-full mx-auto mt-4 mb-2" />
                <div className="flex items-center justify-between px-8 py-4 border-b border-slate-100">
                  <h3 className="font-black text-slate-900 text-lg">Keranjang Belanja</h3>
        ...
        {showReceipt && lastTransaction && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white p-6 lg:p-8 rounded-[32px] shadow-2xl max-w-sm w-full overflow-hidden"
            >
              ...
              <div ref={receiptRef} className="bg-white p-4 border border-slate-200 rounded-xl font-mono text-[10px] leading-tight text-slate-800">
...
const CartContent: React.FC<CartContentProps> = ({ 
  ...
  <div className="flex flex-col h-full">
    <div className="p-6 lg:p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 hidden lg:flex">
      <div>
        <h3 className="font-black text-slate-900 text-lg flex items-center gap-2">
          <ShoppingCart className="w-6 h-6 text-rose-600" />
          Keranjang
        </h3>
        <p className="text-xs text-slate-500 font-medium">Zhuxin Florist Order</p>
      </div>
      <span className="bg-rose-600 text-white text-xs font-black px-3 py-1.5 rounded-full shadow-lg shadow-rose-200">
      ...
      <AnimatePresence mode="popLayout">
        {cart.length > 0 ? cart.map((item) => (
          ...
          <div className="h-full flex flex-col items-center justify-center text-slate-400 py-20">
            ...
            <p className="text-xs text-slate-400 mt-1">Pilih bunga cantik untuk memulai</p>
          </div>
        )}
      </AnimatePresence>
    </div>

    <div className="p-6 lg:p-8 bg-slate-50 border-t border-slate-100 space-y-6">
      <div className="space-y-3">
        <div className="flex justify-between text-xs lg:text-sm font-medium text-slate-500">
          <span>Subtotal</span>
        ...
        <div className="flex justify-between text-xl lg:text-2xl font-black text-slate-900 pt-4 border-t border-slate-200">
          <span>Total</span>
      ...
      <div className="grid grid-cols-3 gap-2 lg:gap-3">
        {[
          ...
          <button
            ...
            className={cn(
              "flex flex-col items-center justify-center p-2 lg:p-3 rounded-2xl border-2 transition-all gap-1",
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input 
              ...
              placeholder="0"
              className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 outline-none transition-all font-black text-slate-800"
            />
          </div>
      ...
      <button 
        ...
        className="w-full py-4 lg:py-5 bg-gradient-to-r from-rose-600 to-pink-600 text-white font-black rounded-[20px] lg:rounded-[24px] hover:shadow-2xl hover:shadow-rose-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-[0.98] tracking-widest text-sm lg:text-base"
      >
        PROSES PEMBAYARAN
      </button>
    </div>
